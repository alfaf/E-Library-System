			...
			if(mysql_num_rows($qry_result) > 0){
				...
				// Insert a new row in the table for each person returned
					while($row = mysql_fetch_array($qry_result)) {
						...
						$display_string .= "<td class='badge' colspan='4'><center><center><input type='button' value='Renew' onclick=renewStudent($book_id,'$register_id',$fine) id='renbake' class='btn tiny'/></td>";
						$display_string .= "<td><input type='button' value='Clear' onclick=clearRenewBookStudentForm() class='btn'/></center></td>";
						$display_string .= "</tr>";
