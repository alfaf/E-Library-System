		...
		if(mysql_num_rows($qry_result) > 0){
			...
			$fine = 0;
				...
				while($row = mysql_fetch_array($qry_result)) {
					...
					$display_string .= "<td class='badge' colspan='4'><input type='button' value='Return' onclick=returnedStudent($book_id,'$register_id',$fine) id='fish' class='btn tiny'/></td>";
					$display_string .= "<td><input type='button' value='Clear' onclick=clearReturnBookStudentDetails() class='btn'/></td>";
					$display_string .= "</tr>";
